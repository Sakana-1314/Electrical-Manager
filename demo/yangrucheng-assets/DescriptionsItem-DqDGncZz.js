import{n as p,m as e,ac as F,p as z,q as D,aI as G,aJ as H,d as E,aN as N,l as n,aO as q,s as J,t as L,v as K,y as j,aP as W,aL as T}from"./index-lOcKc7k9.js";import{g as Q}from"./get-slot-Bk_rJcZu.js";import{u as U}from"./use-compitable-MQFRVxTi.js";function M(t,g="default",d=[]){const{children:s}=t;if(s!==null&&typeof s=="object"&&!Array.isArray(s)){const i=s[g];if(typeof i=="function")return i()}return d}const X=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
