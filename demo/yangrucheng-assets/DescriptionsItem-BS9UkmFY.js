import{q as p,p as e,ae as F,s as z,t as D,aK as G,aL as H,d as E,aP as K,n,aQ as N,v as q,x as L,y as Q,A as j,aR as W,aN as T}from"./index-DiWDHsV5.js";import{g as J}from"./get-slot-Bk_rJcZu.js";import{u as U}from"./use-compitable-BVu4-tV_.js";function M(t,g="default",d=[]){const{children:s}=t;if(s!==null&&typeof s=="object"&&!Array.isArray(s)){const i=s[g];if(typeof i=="function")return i()}return d}const X=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
 ...
 `))]),V="DESCRIPTION_ITEM_FLAG";function Y(t){return typeof t=="object"&&t&&!Array.isArray(t)?t.type&&t.type[V]:!1}const Z=Object.assign(Object.assign({},L.props),{title:String,column:{type:Number,default:3},columns:Number,labelPlacement:{type:String,default:"top"},labelAlign:{type:String,default:"left"},separator:{type:String,default:":"},size:String,bordered:Boolean,labelClass:String,labelStyle:[Object,String],contentClass:String,contentStyle:[Object,String]}),ne=E({name:"Descriptions",props:Z,slots:Object,setup(t){const{mergedClsPrefixRef:g,inlineThemeDisabled:d,mergedComponentPropsRef:s}=q(t),i=j(()=>{var l,a;return t.size||((a=(l=s?.value)===null||l===void 0?void 0:l.Descriptions)===null||a===void 0?void 0:a.size)||"medium"}),h=L("Descriptions","-descriptions",X,W,t,g),$=j(()=>{const{bordered:l}=t,a=i.value,{common:{cubicBezierEaseInOut:_},self:{titleTextColor:r,thColor:P,thColorModal:v,thColorPopover:R,thTextColor:A,thFontWeight:k,tdTextColor:I,tdColor:o,tdColorModal:f,tdColorPopover:O,borderColor:c,borderColorModal:m,borderColorPopover:y,borderRadius:w,lineHeight:u,[T("fontSize",a)]:S,[T(l?"thPaddingBordered":"thPadding",a)]:x,[T(l?"tdPaddingBordered":"tdPadding",a)]:C}}=h.value;return{"--n-title-text-color":r,"--n-th-padding":x,"--n-td-padding":C,"--n-font-size":S,"--n-bezier":_,"--n-th-font-weight":k,"--n-line-height":u,"--n-th-text-color":A,"--n-td-text-color":I,"--n-th-color":P,"--n-th-color-modal":v,"--n-th-color-popover":R,"--n-td-color":o,"--n-td-color-modal":f,"--n-td-color-popover":O,"--n-border-radius":w,"--n-border-color":c,"--n-border-color-modal":m,"--n-border-color-popover":y}}),b=d?Q("descriptions",j(()=>{let l="";const{bordered:a}=t;return a&&(l+="a"),l+=i.value[0],l}),$,t):void 0;return{mergedClsPrefix:g,cssVars:d?void 0:$,themeClass:b?.themeClass,onRender:b?.onRender,compitableColumn:U(t,["columns","column"]),inlineThemeDisabled:d,mergedSize:i}},render(){const t=this.$slots.default,g=t?K(t()):[];g.length;const{contentClass:d,labelClass:s,compitableColumn:i,labelPlacement:h,labelAlign:$,mergedSize:b,bordered:l,title:a,cssVars:_,mergedClsPrefix:r,separator:P,onRender:v}=this;v?.();const R=g.filter(o=>Y(o)),A={span:0,row:[],secondRow:[],rows:[]},I=R.reduce((o,f,O)=>{const c=f.props||{},m=R.length-1===O,y=["label"in c?c.label:M(f,"label")],w=[M(f)],u=c.span||1,S=o.span;o.span+=u;const x=c.labelStyle||c["label-style"]||this.labelStyle,C=c.contentStyle||c["content-style"]||this.contentStyle;if(h==="left")l?o.row.push(n("th",{class:[`${r}-descriptions-table-header`,s],colspan:1,style:x},y),n("td",{class:[`${r}-descriptions-table-content`,d],colspan:m?(i-S)*2+1:u*2-1,style:C},w)):o.row.push(n("td",{class:`${r}-descriptions-table-content`,colspan:m?(i-S)*2:u*2},n("span",{class:[`${r}-descriptions-table-content__label`,s],style:x},[...y,P&&n("span",{class:`${r}-descriptions-separator`},P)]),n("span",{class:[`${r}-descriptions-table-content__content`,d],style:C},w)));else{const B=m?(i-S)*2:u*2;o.row.push(n("th",{class:[`${r}-descriptions-table-header`,s],colspan:B,style:x},y)),o.secondRow.push(n("td",{class:[`${r}-descriptions-table-content`,d],colspan:B,style:C},w))}return(o.span>=i||m)&&(o.span=0,o.row.length&&(o.rows.push(o.row),o.row=[]),h!=="left"&&o.secondRow.length&&(o.rows.push(o.secondRow),o.secondRow=[])),o},A).rows.map(o=>n("tr",{class:`${r}-descriptions-table-row`},o));return n("div",{style:_,class:[`${r}-descriptions`,this.themeClass,`${r}-descriptions--${h}-label-placement`,`${r}-descriptions--${$}-label-align`,`${r}-descriptions--${b}-size`,l&&`${r}-descriptions--bordered`]},a||this.$slots.header?n("div",{class:`${r}-descriptions-header`},a||J(this,"header")):null,n("div",{class:`${r}-descriptions-table-wrapper`},n("table",{class:`${r}-descriptions-table`},n("tbody",null,h==="top"&&n("tr",{class:`${r}-descriptions-table-row`,style:{visibility:"collapse"}},N(i*2,n("td",null))),I))))}}),ee={label:String,span:{type:Number,default:1},labelClass:String,labelStyle:[Object,String],contentClass:String,contentStyle:[Object,String]},le=E({name:"DescriptionsItem",[V]:!0,props:ee,slots:Object,render(){return null}});export{le as _,ne as a};
