...
-- 现存数据与默认项目都是 P05；新增项目在「系统管理 → 项目管理」里维护。
...
-- 默认项目 P05（首次导入的既有数据都归它）。重复导入不改变已有项目的启用状态。
INSERT INTO `project` (`code`, `name`, `enabled`, `is_default`, `remark`)
VALUES ('P05', 'P05 项目', 1, 1, '华星现有项目')
ON DUPLICATE KEY UPDATE `name` = VALUES(`name`), `is_default` = VALUES(`is_default`);

SET @p05_project_id = (SELECT `id` FROM `project` WHERE `code` = 'P05');
...
VALUES
  (@p05_project_id, '个人防护用品', '个体劳动防护用品、用具未使用或未能正确使用'),
  (@p05_project_id, '个人防护用品', '劳动防护用品用具缺乏或有缺陷'),
  (@p05_project_id, '个人防护用品', '防护用品维护、更换不及时'),
  (@p05_project_id, '个人防护用品', '防护用品选型不匹配'),
  (@p05_project_id, '交通安全', '交通安全管理缺陷，如未进行设备点检、车辆维护保养缺失或不足等'),
  (@p05_project_id, '交通安全', '交通安全行为不规范，如超速、不按规定路线行驶等'),
  (@p05_project_id, '交通安全', '交通标志、信号、道路标线缺陷'),
  (@p05_project_id, '交通安全', '交通环境不良、路面滑、不平、道路排水不良、能见度差等'),
  (@p05_project_id, '交通安全', '交通设备机具缺陷，如：轮胎磨损严重、制动系统故障等'),
  (@p05_project_id, '交通安全', '叉车、工程车辆管理缺陷'),
  (@p05_project_id, '交通安全', '夜间行车安全措施不足'),
  (@p05_project_id, '交通安全', '驾驶人员无证或违规驾驶'),
  (@p05_project_id, '人的不安全行为', '不佩戴或错误使用劳动防护用品'),
  (@p05_project_id, '人的不安全行为', '不安全的行为习惯'),
  (@p05_project_id, '人的不安全行为', '作业未设专人监护或违章指挥'),
  (@p05_project_id, '人的不安全行为', '侥幸心理、冒险行为'),
  (@p05_project_id, '人的不安全行为', '冒险进入危险区域、场所'),
  (@p05_project_id, '人的不安全行为', '对易燃、易爆等危险物品处理错误'),
  (@p05_project_id, '人的不安全行为', '心理、生理状况异常'),
  (@p05_project_id, '人的不安全行为', '擅自改变工艺或操作方式'),
  (@p05_project_id, '人的不安全行为', '攀爬、坐、站立不安全位置'),
  (@p05_project_id, '人的不安全行为', '有分散注意力行为'),
  (@p05_project_id, '人的不安全行为', '未持证上岗'),
  (@p05_project_id, '人的不安全行为', '物料、物体堆、存放不当'),
  (@p05_project_id, '人的不安全行为', '误操作、忽视安全、忽视警告'),
  (@p05_project_id, '人的不安全行为', '违反劳动纪律'),
  (@p05_project_id, '人的不安全行为', '违章作业'),
  (@p05_project_id, '人的不安全行为', '违章指挥'),
  (@p05_project_id, '人的不安全行为', '违规使用工器具和设备'),
  (@p05_project_id, '作业环境因素', '作业场地安全通道、出口缺陷'),
  (@p05_project_id, '作业环境因素', '其他作业环境不良（如：强迫体位、综合性作业环境不良）'),
  (@p05_project_id, '作业环境因素', '室内作业场所环境不良（如地面滑、地面不平、采光照明不良、空气不良、场地杂乱等）'),
  (@p05_project_id, '作业环境因素', '室外作业场所环境不良（如恶劣的气候与环境、作业场地狭窄、杂乱、地面不平等）'),
  (@p05_project_id, '作业环境因素', '建(构)筑物和其他结构缺陷'),
  (@p05_project_id, '作业环境因素', '气体聚集、缺氧风险'),
  (@p05_project_id, '作业环境因素', '职业卫生类'),
  (@p05_project_id, '作业环境因素', '运动物危害'),
  (@p05_project_id, '其他管理缺陷', '作业人员资质不符合要求'),
  (@p05_project_id, '其他管理缺陷', '安全操作规程、不健全、缺失'),
  (@p05_project_id, '其他管理缺陷', '安全生产管理制度、不健全、缺失'),
  (@p05_project_id, '其他管理缺陷', '安全生产管理档案资料丢失、未按规定存档'),
  (@p05_project_id, '其他管理缺陷', '安全管理人员配备不足、未成立机构等'),
  (@p05_project_id, '其他管理缺陷', '应急预案体系不健全、预案不规范、演练不规范、应急物资配备不全、保存不当'),
  (@p05_project_id, '其他管理缺陷', '教育培训不到位、培训计划不适用、培训效果不达标等'),
  (@p05_project_id, '其他管理缺陷', '未建立台账、事故原因分析不全面/不深入、整改没有有效落实四不放过原则'),
  (@p05_project_id, '其他管理缺陷', '未落实相关EHS职责'),
  (@p05_project_id, '其他管理缺陷', '隐患整改资金未落实'),
  (@p05_project_id, '其他管理缺陷', '隐患整改闭环不到位'),
  (@p05_project_id, '危险化学品安全', '危化品台账不完善'),
  (@p05_project_id, '危险化学品安全', '危化品泄漏、跑冒滴漏'),
  (@p05_project_id, '危险化学品安全', '危险化学品使用不规范：使用易燃易爆物品作业时附近有明火'),
  (@p05_project_id, '危险化学品安全', '危险化学品存储不合规或不规范'),
  (@p05_project_id, '危险化学品安全', '危险化学品应急管理缺陷'),
  (@p05_project_id, '危险化学品安全', '危险化学品未定期检查、巡检不到位'),
  (@p05_project_id, '危险化学品安全', '危险化学品管理缺陷，如没有MSDS、容器缺少标签、安全标志不全或缺失、未建立台账等'),
  (@p05_project_id, '危险化学品安全', '危险化学品运输机具或设备、工器具、附件类缺陷'),
  (@p05_project_id, '安全警示和安全标识', '临时作业警示标识不到位'),
  (@p05_project_id, '安全警示和安全标识', '危险区域无禁止标识'),
  (@p05_project_id, '安全警示和安全标识', '安全色、警示线设置不规范'),
  (@p05_project_id, '安全警示和安全标识', '安全警示标识损坏、模糊'),
  (@p05_project_id, '安全警示和安全标识', '安全警示标识缺失'),
  (@p05_project_id, '安全警示和安全标识', '禁令、指令标识不规范'),
  (@p05_project_id, '安全警示和安全标识', '警示标识设置位置不合理'),
  (@p05_project_id, '安全警示和安全标识', '风险告知标识缺失'),
  (@p05_project_id, '建设施工安全', '临时楼梯、平台、护栏、跳板等搭设有缺陷或不规范'),
  (@p05_project_id, '建设施工安全', '交叉作业安全措施不足'),
  (@p05_project_id, '建设施工安全', '其他施工作业不规范'),
  (@p05_project_id, '建设施工安全', '吊篮作业不规范'),
  (@p05_project_id, '建设施工安全', '土石方作业不规范'),
  (@p05_project_id, '建设施工安全', '基坑、高处、孔洞、临边无防护或防护不足'),
  (@p05_project_id, '建设施工安全', '施工人员安全培训不足'),
  (@p05_project_id, '建设施工安全', '施工用电、用火不规范'),
  (@p05_project_id, '建设施工安全', '模板工程不规范'),
  (@p05_project_id, '建设施工安全', '脚手架搭设不规范或有缺陷'),
  (@p05_project_id, '建设施工安全', '边坡作业不规范'),
  (@p05_project_id, '文明施工', '其他不符合文明施工的问题'),
  (@p05_project_id, '文明施工', '未做好工完料净场地清'),
  (@p05_project_id, '文明施工', '材料、设备、预制件等物品堆放不规范'),
  (@p05_project_id, '文明施工', '现场的建筑垃圾未及时清理'),
  (@p05_project_id, '文明施工', '现场的生活垃圾乱扔、乱堆、未及时处理等'),
  (@p05_project_id, '消防安全', '不符合管理要求'),
  (@p05_project_id, '消防安全', '易燃易爆区域不合规或作业不规范'),
  (@p05_project_id, '消防安全', '易燃易爆物品管理不规范'),
  (@p05_project_id, '消防安全', '消防器材、物资存放不当'),
  (@p05_project_id, '消防安全', '消防档案资料缺失或管理不当'),
  (@p05_project_id, '消防安全', '消防设施、设备未定期维护或维保不足'),
  (@p05_project_id, '消防安全', '消防设施、设备缺陷'),
  (@p05_project_id, '消防安全', '消防设施配置不足'),
  (@p05_project_id, '消防安全', '消防通道、疏散通道不畅'),
  (@p05_project_id, '消防安全', '火灾风险辨识不到位'),
  (@p05_project_id, '特种设备安全', '操作人员无证或证件过期'),
  (@p05_project_id, '特种设备安全', '日常检查、维护不到位'),
  (@p05_project_id, '特种设备安全', '特种设备、附件缺陷'),
  (@p05_project_id, '特种设备安全', '特种设备使用环境缺陷'),
  (@p05_project_id, '特种设备安全', '特种设备操作行为不规范'),
  (@p05_project_id, '特种设备安全', '特种设备管理缺陷'),
  (@p05_project_id, '特种设备安全', '起重吊具、索具不合格'),
  (@p05_project_id, '环保', '危废暂存、转运不规范'),
  (@p05_project_id, '环保', '危废管理处置'),
  (@p05_project_id, '环保', '大气污染'),
  (@p05_project_id, '环保', '工业垃圾处置'),
  (@p05_project_id, '环保', '水污染'),
  (@p05_project_id, '环保', '漏料、撒料'),
  (@p05_project_id, '环保', '环保台账记录不完整'),
  (@p05_project_id, '环保', '环保设备、设施维护不到位、运行异常'),
  (@p05_project_id, '环保', '生活垃圾处置'),
  (@p05_project_id, '环保', '能源、材料、资源浪费'),
  (@p05_project_id, '环保', '跑冒滴漏污染环境'),
  (@p05_project_id, '现场5S', '整理'),
  (@p05_project_id, '现场5S', '整顿'),
  (@p05_project_id, '现场5S', '清扫'),
  (@p05_project_id, '现场5S', '清洁'),
  (@p05_project_id, '现场5S', '素养'),
  (@p05_project_id, '生产设备设施安全', '急停、拉绳装置失效'),
  (@p05_project_id, '生产设备设施安全', '护栏、平台、梯台等防护缺陷'),
  (@p05_project_id, '生产设备设施安全', '检修状态防护不到位'),
  (@p05_project_id, '生产设备设施安全', '联锁、保护装置失效'),
  (@p05_project_id, '生产设备设施安全', '设备在非正常环境状态下运行，如：恶劣环境、灰尘超标、腐蚀性环境等'),
  (@p05_project_id, '生产设备设施安全', '设备未定期检查、检查记录不规范'),
  (@p05_project_id, '生产设备设施安全', '设备设施、工具、附件有缺陷'),
  (@p05_project_id, '生产设备设施安全', '设备设施标志缺陷'),
  (@p05_project_id, '生产设备设施安全', '设备设施管理类，如：未建立台账、验收不规范、保养检维修不到位等'),
  (@p05_project_id, '生产设备设施安全', '设备设施防护缺陷'),
  (@p05_project_id, '生产设备设施安全', '转动、传动部位防护不到位'),
  (@p05_project_id, '电气安全', '低压操作行为不合规、不规范'),
  (@p05_project_id, '电气安全', '低压电气设备设施缺陷'),
  (@p05_project_id, '电气安全', '低压配电系统缺陷'),
  (@p05_project_id, '电气安全', '升压系统类，如：变压器、断路器、隔离开关、电容器、电抗器、自动调压装置和保护装置缺陷等'),
  (@p05_project_id, '电气安全', '变电站系统，如变压器、断路器、隔离开关、接地开关、继电器保护装置、无功补偿设备等缺陷'),
  (@p05_project_id, '电气安全', '带电作业不规范'),
  (@p05_project_id, '电气安全', '带电部位防护不到位'),
  (@p05_project_id, '电气安全', '接地、接零不符合要求'),
  (@p05_project_id, '电气安全', '涉爆区域电气安全隐患'),
  (@p05_project_id, '电气安全', '漏电保护装置缺失或失效'),
  (@p05_project_id, '电气安全', '电气管理缺陷，如两票三制、档案资料、工器具缺陷等'),
  (@p05_project_id, '电气安全', '电缆敷设不规范'),
  (@p05_project_id, '电气安全', '配电设施设置不规范'),
  (@p05_project_id, '电气安全', '高中压配电系统缺陷'),
  (@p05_project_id, '电气安全', '高压操作类行为不规范'),
  (@p05_project_id, '电气安全', '高压输电系统缺陷'),
  (@p05_project_id, '高风险作业安全', '临时用电作业不规范'),
  (@p05_project_id, '高风险作业安全', '作业JSA分析不到位、安全技术交底不到位'),
  (@p05_project_id, '高风险作业安全', '作业安全监护未落实或未有效落实'),
  (@p05_project_id, '高风险作业安全', '作业未按要求执行作业票管理程序进行签票'),
  (@p05_project_id, '高风险作业安全', '作业票填写不规范、有修改涂抹、相关人员未签字、未进行闭环管理等'),
  (@p05_project_id, '高风险作业安全', '其他作业不规范（如：非常规类授权类作业）'),
  (@p05_project_id, '高风险作业安全', '动土作业不规范'),
  (@p05_project_id, '高风险作业安全', '动火作业不规范'),
  (@p05_project_id, '高风险作业安全', '占道或断路作业不规范'),
  (@p05_project_id, '高风险作业安全', '危险作业人员不符合要求（如未持证、身体条件不符合、能力不具备等）'),
  (@p05_project_id, '高风险作业安全', '危险性较大设备设施检维修作业不规范'),
  (@p05_project_id, '高风险作业安全', '受限空间作业不规范'),
  (@p05_project_id, '高风险作业安全', '吊装作业不规范'),
  (@p05_project_id, '高风险作业安全', '带电作业管理缺陷'),
  (@p05_project_id, '高风险作业安全', '挂牌上锁作业不规范'),
  (@p05_project_id, '高风险作业安全', '检修作业安全措施不到位'),
  (@p05_project_id, '高风险作业安全', '高处作业不规范')
